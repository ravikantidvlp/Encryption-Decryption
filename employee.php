...
<body>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body add_epmployee">
                    <div class="form-group">
                        ...
                        <input type="text" id="fname_input" class="form-control" >
                    </div>
                    <div class="form-group">
                        <label>LastName</label>
                        <input type="text" id="lname_input" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>Email</label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body edit_employee">
                    <div class="form-group">
                        ...
                        <input type="text" id="fname_input" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Last Name</label>
                        <input type="text" id="lname_input" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Email</label>
                        <input type="email" id="email_input" class="form-control" required>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body view_employee">
                    <div class="form-group">
                        <label>FirstName</label>
                        <input type="text" id="fname_input" class="form-control" readonly>
                    </div>
                    <div class="form-group">
                        <label>LastName</label>
                        <input type="text" id="lname_input" class="form-control" readonly>
                    </div>
                    <div class="form-group">
                        <label>Email</label>
    ...
    <script>
        ...
        function addEmployee() {
            var fname = $('.add_epmployee #fname_input').val();
            var lname = $('.add_epmployee #lname_input').val();
        ...
        function editEmployee() {
            var fname = $('.edit_employee #fname_input').val();
            var lname = $('.edit_employee #lname_input').val();
        ...
        function viewEmployee(id = 2) {
            $.ajax({
                ...
                success: function (data) {
                    var response = JSON.parse(data);
                    $('.edit_employee #fname_input').val(response.firstname);
                    $('.edit_employee #lname_input').val(response.lastname);
